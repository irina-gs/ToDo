...
final class SnackBarView: UIView {
    ...
    func show(view: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.topAnchor.constraint(equalTo: topAnchor, constant: heightStatusBar),
            messageLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -20),
        ])

        let height: CGFloat = heightStatusBar + messageLabel.sizeThatFits(CGSize(width: frame.width, height: .infinity)).height + 20
